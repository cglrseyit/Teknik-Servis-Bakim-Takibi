  ...
  try {
    ...
    const detail = JSON.stringify({
      equipment: {
        ...
        serial_number: eq.serial_number, location: eq.location,
        category: eq.category, supplier: eq.supplier,
        install_date: eq.install_date, warranty_end: eq.warranty_end,
      ...
      last_task: taskRows[0] ? {
        ...
        replaced_parts: taskRows[0].replaced_parts,
